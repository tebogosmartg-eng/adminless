...
import { CalendarIcon, Lock, Unlock, Plus } from "lucide-react";
    ...
    <div className="grid gap-6 md:grid-cols-1">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create and manage school years. Selecting a year allows you to edit its terms.</CardDescription>
        </CardHeader>
