...
import ClassStatsComponent from '@/components/ClassStats';
import MarkDistributionChartComponent from '@/components/MarkDistributionChart';
      ...
      {!showComments && (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="lg:col-span-1">
            <ClassStatsComponent learners={learners} />
          </div>
          <div className="lg:col-span-1">
            <MarkDistributionChartComponent
              learners={learners}
